...
function setUpSections() {
    var e = document.getElementsByTagName("body")[0].getElementsByTagName("section");
    for (i = 0; i < e.length; i++) {
        switch (e[i].getAttribute("data-direction")) {
            case "from-bottom":
                _position = {
                    top: "100%"
                }, _destination = {
        ...
        e[i].positions = _position, e[i].destinations = _destination, e[i].headerDestinations = _headerDestination, e[i].headerOrigins = _headerOrigin
    }
}

function openContent(e, t) {
    _element = document.querySelector(e), $(e).css(_element.positions).css({
        "z-index": 2
...
function closeContent(e) {
    _target = "section.active", _element = document.querySelector(_target), $(_target).removeClass("active").delay(300).animate(_element.positions, "easeOutQuint", function() {
        $(this).css({
            "z-index": 0
        })
